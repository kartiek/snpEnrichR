...
findProxies <- function(path2RefDir,path2leadSNPList,proxyWindow=1000,proxyCorr=0.8,path2Proxies,useMaf=TRUE,maf=0.01,useHWE=TRUE,hwe=10e-6,useGENO=TRUE,geno=0.1)
  {
