...
```R
  download.file(snpSNAPUrl,
                "../Data/SNPSnap_Psoriasis_download",
                method="wget",
                quiet = FALSE, 
                mode = "w")
  unzip(zipfile="../Data/SNPSnap_dl",exdir="../Data/")
```
...
```
If became confident, the matched SNPs can be downloaded 

<!--
%```R
%matchedSnps <- read.table(file.path("../Data/SNPsnap_Psoriasis/",
%                                    "matched_snps.txt"),
%                           stringsAsFactors = F,
%                           header=T)
%```
...
findProxies(path2PlinkPrefix="../Data/ThousandGenomes/1kp3_snpSNAP",
            snplist=matchedSnps[,1],
            path2Proxies="../Data/Psoriasis/input_Proxies/PS")
            
findProxies("/l/snp/new/Data/ThousandGenomes/1kp3_snpSNAP",
            unique(unlist(matchedSnps[,-1])),
            path2Proxies = "../Data/Psoriasis/snpsnap_Proxies/PS")
            
```
# `analyzeEnrichment`: Perform the actual analysis

```
analyzeEnrichment(regionPath="../Data/myTFBSites.tsv",
                  regionHeader=c('chr','start','end'),
                  SNPsnapPath="../Data/SNPsnap_",
                  numberOfRandomSNPsets=1000,
                  LSProxyPathPrefix="../Data/Psoriasis/input_Proxies",
                  BGProxyPathPrefix="../Data/Psoriasis/snpsnap_Proxies",
                  traitShort="PS",
                  genomicRegionsName="TF Binding sites",
                  cores=4,
                  resDir="../Data/snpEnrichROutput",
